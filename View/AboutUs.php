  ...
  <div class="register py-5">
    <div class="container py-5">
      <div class="row mb-4">
        ...
        <div class="col-lg-6">
          <h2 class="display-4 font-weight-light">Our Contributors</h2>
          <span>
            <a href="https://park-innovation.com/?ref=lebanesetech" class="navbar-brand">
              <!-- Logo Image -->
              <img src="https://park-innovation.com/images/logo.png" width="100" alt="" class="d-inline-block align-middle mr-2">
            </a>
          </span>
          <span>
            <a href="https://www.techgenies.com/" class="navbar-brand">
              <!-- Logo Image -->
              <img src="https://www.techgenies.com/wp-content/uploads/2019/09/techgenies-logo.png" width="200" alt="" class="d-inline-block align-middle mr-2">
            </a>
          </span>
        </div>
      </div>
      ...
      <div class="row text-center">
        ...
        <!-- Team item-->
        <div class="col-xl-3 col-sm-6 mb-5">
          <div class="bg-white rounded shadow-sm py-5 px-4"><img src="../images/IhabBreich.jpg" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
